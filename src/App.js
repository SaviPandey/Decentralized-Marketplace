    ...
    import bgPurchased from './assets/bgPurchased.png';
    import title from './assets/title.jpg';
    
    function App() {
      const CONTRACT_ADDRESS = "0xbc946809f5fbfffe0265553386d692eee4d71354";    
      const ABI = [
        {
          "inputs": [
            {
        ...
        return (
          <div className="App">
              <h1 style={{ backgroundImage: `url(${title})`}}>Decentralized Marketplace</h1>
              ...
              <div className="items" style={{ backgroundImage: `url(${bgImage})`}}>
                  <h2 style={{color: 'white'}}>Items for Sale</h2>
                  {items.map((item) => (
              ...
              <div className="owned-items" style={{ backgroundImage: `url(${bgPurchased})`}}>
